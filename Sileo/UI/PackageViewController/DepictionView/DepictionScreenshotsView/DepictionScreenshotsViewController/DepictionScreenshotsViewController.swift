...
class DepictionScreenshotsViewController: UIViewController,
    DepictionViewDelegate
{
    ...
    override func viewDidLoad() {
        ...
        screenshotsView = DepictionScreenshotsView(
    ...
    override func viewWillTransition(
        ...
        coordinator.animate(
            alongsideTransition: { _ in
                self.screenshotsView?.scrollToPageIndex(
                    previousIndex,
                    animated: false
                )
            },
