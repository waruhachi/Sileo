...
class LanguageSelectionViewController: BaseSettingsViewController,
    LanguageSelectionCellProtocol
{

    public var useSystemLanguage = UserDefaults.standard.bool(
        forKey: "UseSystemLanguage"
    )
    public var chosenCode = UserDefaults.standard.string(
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(
            title: String(localizationKey: "Apply_Changes"),
            style: .done,
            target: self,
            action: #selector(appylyChanges)
        )
    }
    ...
    @objc private func appylyChanges() {
        ...
        alert.addAction(
            UIAlertAction(
                title: String(localizationKey: "After_Install_Relaunch"),
                style: .destructive,
                handler: { _ in
    ...
    override func tableView(
        ...
        case .languageList:
            return LanguageHelper.shared.availableLanguages.count
        }
    }
    ...
    override func tableView(
        ...
        case .languageList:
            let language = LanguageHelper.shared.availableLanguages[
                indexPath.row
            ]
            let cell: UITableViewCell = self.reusableCell(
                withStyle: .subtitle,
                reuseIdentifier: "LangaugeCellShared"
            )
    ...
    override func tableView(
        ...
        case .helpLocalize:
            UIApplication.shared.open(
                URL(string: "https://crowdin.com/project/sileo")!
            )
        case .languageList:
            for cell in tableView.visibleCells
            where cell.reuseIdentifier == "LangaugeCellShared" {
