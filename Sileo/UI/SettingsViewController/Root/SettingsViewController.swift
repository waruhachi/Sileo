    ...
    override func viewDidLoad() {
        ...
        observer = NotificationCenter.default.addObserver(
            forName: NSNotification.Name(
                rawValue: PaymentProvider.listUpdateNotificationName
            ),
            object: nil,
...
extension SettingsViewController {  // UITableViewDataSource
    ...
    override func tableView(
        ...
        case 0:  // Payment Providers section
            return authenticatedProviders.count + unauthenticatedProviders.count
                + (hasLoadedOnce ? 0 : 1)
        case 1:  // Themes
            return 5
        case 2:
    ...
    override func tableView(
            ...
            if indexPath.row < authenticatedProviders.count {
                ...
                let cell =
                    self.reusableCell(
                        ...
                        reuseIdentifier: id,
                        cellClass: cellClass
                    ) as? PaymentProviderTableViewCell
                cell?.isAuthenticated = true
                cell?.provider = authenticatedProviders[indexPath.row]
                return cell ?? UITableViewCell()
            } else if indexPath.row - authenticatedProviders.count
                < unauthenticatedProviders.count
            {
                ...
                cell?.provider =
                    unauthenticatedProviders[
                        indexPath.row - authenticatedProviders.count
                    ]
                return cell ?? UITableViewCell()
            } else if !hasLoadedOnce
                && (indexPath.row - authenticatedProviders.count
                    - unauthenticatedProviders.count) == 0
            {
                let style = UITableViewCell.CellStyle.subtitle
        ...
        case 1:  // Translation Credit Section OR Settings section
            ...
            case 0:
                ...
                cell.pickerView.selectRow(
                    cell.values.firstIndex(
                        of: SileoThemeManager.shared.currentTheme.name
                    ) ?? 0,
                    inComponent: 0,
                    animated: false
                )
                ...
                cell.subtitle.text =
                    cell.values[cell.pickerView.selectedRow(inComponent: 0)]
            ...
            case 1:
                ...
                return cell
            case 2:
                cell.amyPogLabel.text = String(
                    localizationKey: "Reset_Tint_Color"
                )
                return cell
            case 3:
                cell.amyPogLabel.text = String(
                    localizationKey: "Alternate_Icon_Title"
                )
        ...
        case 2:
            ...
            case 1:
                cell.amyPogLabel.text = String(
                    localizationKey: "Show_Provisional"
                )
                cell.fallback = true
                cell.defaultKey = "ShowProvisional"
            case 2:
                cell.amyPogLabel.text = String(
                    localizationKey: "iCloud_Profile"
                )
                cell.fallback = true
                cell.defaultKey = "iCloudProfile"
            case 3:
                cell.amyPogLabel.text = String(
                    localizationKey: "Show_Ignored_Updates"
                )
                cell.fallback = true
                cell.defaultKey = "ShowIgnoredUpdates"
            case 4:
                cell.amyPogLabel.text = String(
                    localizationKey: "Auto_Refresh_Sources"
                )
                cell.fallback = true
                cell.defaultKey = "AutoRefreshSources"
            case 5:
                cell.amyPogLabel.text = String(
                    localizationKey: "Auto_Complete_Queue"
                )
                cell.defaultKey = "AutoComplete"
            case 6:
                cell.amyPogLabel.text = String(
                    localizationKey: "Show_Search_History"
                )
                cell.defaultKey = "ShowSearchHistory"
                cell.fallback = true
            case 7:
                cell.amyPogLabel.text = String(
                    localizationKey: "Show_Package_Count"
                )
                cell.defaultKey = "ShowPackageCount"
                cell.fallback = true
            case 8:
                cell.amyPogLabel.text = String(
                    localizationKey: "Auto_Show_Queue"
                )
                cell.fallback = true
                cell.defaultKey = "UpgradeAllAutoQueue"
            case 9:
                cell.amyPogLabel.text = String(
                    localizationKey: "Always_Show_Install_Log"
                )
                cell.defaultKey = "AlwaysShowLog"
            case 10:
                cell.amyPogLabel.text = String(
                    localizationKey: "Auto_Confirm_Upgrade_All_Shortcut"
                )
                cell.defaultKey = "AutoConfirmUpgradeAllShortcut"
            case 11:
                cell.amyPogLabel.text = String(
                    localizationKey: "Developer_Mode"
                )
                cell.fallback = false
        ...
        case 3:  // About section
            ...
            case 0:
                ...
                cell.detailLabel.text = FileManager.default.sizeString(
                    EvanderNetworking._cacheDirectory
                )
                return cell
            case 1:
            ...
            case 2:
                cell.amyPogLabel.text = String(
                    localizationKey: "Licenses_Page_Title"
                )
                cell.accessoryType =
                    UITableViewCell.AccessoryType.disclosureIndicator
                return cell
            ...
            case 4:
                cell.amyPogLabel.text = String(
                    localizationKey: "Canister_Policy"
                )
                cell.accessoryType = .disclosureIndicator
                return cell
            default:
    ...
    override func tableView(
        ...
        case 0:  // Payment Providers section
            if indexPath.row < authenticatedProviders.count {
                // Authenticated Provider
                let provider: PaymentProvider = authenticatedProviders[
                    indexPath.row
                ]
                let profileViewController: PaymentProfileViewController =
                    PaymentProfileViewController(provider: provider)
            ...
            {
                // Unauthenticated Provider
                let provider: PaymentProvider = unauthenticatedProviders[
                    indexPath.row - authenticatedProviders.count
                ]
                PaymentAuthenticator.shared.authenticate(
                    ...
                    if error != nil {
                        let title: String = String(
                            localizationKey: "Provider_Auth_Fail.Title",
                            type: .error
                        )
                        self.present(
                            PaymentError.alert(for: error, title: title),
                            animated: true
                        )
                    }
                }
        ...
        case 1:
            ...
            case 3:
                    ...
                    let errorVC = UIAlertController(
                        title: "Not Supported",
                        message:
                            "Alternate Icons are currently not supported in macOS",
                    ...
                    errorVC.addAction(
                        UIAlertAction(
                            title: "Ok",
                            style: .cancel,
                            handler: { _ in errorVC.dismiss(animated: true) }
                        )
                    )
                ...
                #endif
            case 4:
                let menuSettingsVC = ThemesSectionViewController(
                    style: .grouped
                )
        ...
        case 3:  // About section
            ...
            case 0:
                self.cacheClear()
            case 1:
                let teamViewController: SileoTeamViewController =
                    SileoTeamViewController()
                self.navigationController?.pushViewController(
                    teamViewController,
                    animated: true
                )
            case 2:
                let licensesViewController: LicensesTableViewController =
            ...
            case 3:
                let languageSelection = LanguageSelectionViewController(
                    style: .grouped
                )
                self.navigationController?.pushViewController(
                    languageSelection,
            ...
            case 4:
                let vc = PrivacyViewController.viewController(
                    privacyLink: canisterPrivacyPolicy
                )
    ...
    private func cacheClear() {
        let alert = UIAlertController(
            title: String(localizationKey: "Clear_Cache"),
            message: String(
                format: String(localizationKey: "Clear_Cache_Message"),
                FileManager.default.sizeString(
                    EvanderNetworking._cacheDirectory
                )
            ),
            preferredStyle: .alert
    ...
    private func presentAlderis() {
        if #available(iOS 14, *) {
            ...
            let doneButton = UIBarButtonItem(
                ...
                style: .done,
                target: self,
                action: #selector(colorpickerDone)
            )
            colorPickerViewController.navigationItem.rightBarButtonItem =
                doneButton

            let navigationController = UINavigationController(
                rootViewController: colorPickerViewController
            )
            navigationController.modalPresentationStyle = .formSheet
            navigationController.view.backgroundColor =
                UIColor.sileoBackgroundColor
            colorPickerViewController.preferredContentSize = CGSize(
                width: 320,
                height: 480
            )
            ...
            colorPickerViewController.delegate = self
            colorPickerViewController.configuration = ColorPickerConfiguration(
                color: .tintColor
            )
            if UIDevice.current.userInterfaceIdiom == .pad {
                if #available(iOS 13, *) {
                    colorPickerViewController.popoverPresentationController?
    ...
    @objc func colorpickerDone() {
        if let colorPickerViewController = presentedViewController
            as? UINavigationController,
            let picker = colorPickerViewController.viewControllers.first
                as? UIColorPickerViewController
        {
    ...
    override func tableView(
        ...
        if indexPath.section == 0
            && (indexPath.row < auth || indexPath.row - auth < unauth)
        {
            return 54
        }
    ...
    func themeSelected(_ index: Int) {
        SileoThemeManager.shared.activate(
            theme: SileoThemeManager.shared.themeList[index]
        )
    }
...
extension SettingsViewController: ColorPickerDelegate {
    func colorPicker(
        _ colorPicker: ColorPickerViewController,
