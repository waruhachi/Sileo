...
class ThemePickerCell: UITableViewCell, UIPickerViewDelegate,
    UIPickerViewDataSource
{
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        title.topAnchor.constraint(equalTo: contentView.topAnchor).isActive =
            true
        subtitle.trailingAnchor.constraint(
            equalTo: contentView.trailingAnchor,
            constant: -20
        ).isActive = true
        subtitle.topAnchor.constraint(equalTo: contentView.topAnchor).isActive =
            true
        title.heightAnchor.constraint(equalToConstant: standardHeight)
            .isActive = true
        subtitle.heightAnchor.constraint(equalToConstant: standardHeight)
            .isActive = true
        ...
        separator.trailingAnchor.constraint(equalTo: contentView.trailingAnchor)
            .isActive = true
        separator.topAnchor.constraint(equalTo: title.bottomAnchor).isActive =
            true
