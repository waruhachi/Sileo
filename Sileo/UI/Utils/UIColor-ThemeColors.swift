...
extension UIColor {
    ...
    static var isDarkModeEnabled: Bool {
            ...
            == .dark
        {
            ...
            .preferredUserInterfaceStyle == .system
        {
            if #available(iOS 13, *) {
    ...
    static var sileoBackgroundColor: UIColor {
        if #available(iOS 13, *) {
            return SileoThemeManager.shared.currentTheme.backgroundColor
                ?? .systemBackground
        }
    ...
    static var sileoContentBackgroundColor: UIColor {
        SileoThemeManager.shared.currentTheme.secondaryBackgroundColor
            ?? UIColor(white: 245 / 255, alpha: 1)
    }
    ...
    static var sileoHighlightColor: UIColor {
        SileoThemeManager.shared.currentTheme.highlightColor
            ?? UIColor(white: 0.9, alpha: 1)
    }

    static var sileoSeparatorColor: UIColor {
        SileoThemeManager.shared.currentTheme.seperatorColor
            ?? UIColor(
                red: 234.0 / 255.0,
                green: 234.0 / 255.0,
                blue: 236.0 / 255.0,
    ...
    static var sileoHeaderColor: UIColor {
        SileoThemeManager.shared.currentTheme.headerColor
            ?? UIColor(red: 0.898, green: 0.98, blue: 1, alpha: 0.5)
    }

    static var sileoBannerColor: UIColor {
        SileoThemeManager.shared.currentTheme.bannerColor
            ?? UIColor(red: 0.941, green: 0.996, blue: 1, alpha: 1)
    }
