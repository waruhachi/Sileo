...
class SourceProgressIndicatorView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        barView.bottomAnchor.constraint(equalTo: self.bottomAnchor).isActive =
            true
        barView.leadingAnchor.constraint(equalTo: self.leadingAnchor).isActive =
            true
    }
    ...
    func updateProgress() {
        ...
        barWidthConstraint = barView.widthAnchor.constraint(
            equalTo: self.widthAnchor,
            multiplier: self.progress
        )
