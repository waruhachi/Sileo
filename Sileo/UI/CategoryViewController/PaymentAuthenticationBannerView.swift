...
final class PaymentAuthenticationBannerView: UIView {
    ...
    init(
        ...
        bannerDictionary: [String: String],
        ...
        button.addTarget(
            self,
            action: #selector(PaymentAuthenticationBannerView.buttonTapped),
            for: .touchUpInside
        )
        ...
        separatorView.bottomAnchor.constraint(equalTo: self.bottomAnchor)
            .isActive = true
        hairlineHeightConstraint = separatorView.heightAnchor.constraint(
            equalToConstant: 1
        )
