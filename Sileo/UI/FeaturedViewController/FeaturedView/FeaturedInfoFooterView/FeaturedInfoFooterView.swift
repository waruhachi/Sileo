...
class FeaturedInfoFooterView: FeaturedBaseView {
    ...
    required init?(
        ...
        if sileoVersion == "Unknown" {
            if let sileoVersionBundle = Bundle.main.infoDictionary?[
    ...
    static var package: Package? {
        ...
        case "org.coolstar.SileoBeta":
            return PackageListManager.shared.installedPackage(
                identifier: "org.coolstar.sileobeta"
            )
        case "org.coolstar.SileoNightly":
            return PackageListManager.shared.installedPackage(
                identifier: "org.coolstar.sileonightly"
            )
        default:
            return PackageListManager.shared.installedPackage(
                identifier: "org.coolstar.sileo"
            )
        }
    }
