...
class NewsResolver {
    ...
    public func getArticles() {
        ...
        EvanderNetworking.request(
            ...
            strong.articles = strong.articles.filter({
                $0.date
                    > Date(
            ...
            let shouldShow = strong.articles.contains(where: {
                $0.date
                    > Date(
                        timeIntervalSince1970: Date().timeIntervalSince1970
                            - 1_209_600
