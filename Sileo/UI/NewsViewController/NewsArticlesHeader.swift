...
class NewsArticlesHeader: UICollectionViewCell {
    ...
    private var gradientView: NewsGradientBackgroundView =
        NewsGradientBackgroundView()
    ...
    override init(frame: CGRect) {
        viewController =
            UINib(
                nibName: "NewsArticlesViewController",
                bundle: nil
            ).instantiate(
                withOwner: nil,
                options: nil
            )[0] as? NewsArticlesViewController ?? NewsArticlesViewController()
