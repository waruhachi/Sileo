...
class FlaggedSourceWarningViewController: SileoViewController {
    ...
    override func viewDidLoad() {
        ...
        continueButton.setTitle(
            String(localizationKey: "Dangerous_Repo.Continue"),
            for: .normal
        )
        safetyButton.setTitle(
            String(localizationKey: "Dangerous_Repo.Cancel"),
            for: .normal
        )
    ...
    func determineScrollHairlineAnimated(animated: Bool) {
        FRUIView.animate(
            ...
            animations: {
                self.scrollHairlineView.alpha =
                    self.scrollView.contentOffset.y >= self.scrollView
