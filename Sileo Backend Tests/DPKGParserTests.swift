...
final class DPKGParserTests: XCTestCase {
    ...
    func testAMaintainerParser() throws {
        ...
        XCTAssert(
            case1Maintainer.name == "Amy While"
                && case1Maintainer.email == "me@anamy.gay",
            "Failed to parse \(case1)"
        )
        let case2Maintainer = Maintainer(string: case2)
        XCTAssert(
            case2Maintainer.name == "Amy While" && case2Maintainer.email == nil,
            "Failed to parse \(case2)"
        )
        let case3Maintainer = Maintainer(string: case3)
        XCTAssert(
            case3Maintainer.name == "Amy While" && case3Maintainer.email == nil,
            "Failed to parse \(case3), got: \(dump(case3Maintainer))"
        )
    }
